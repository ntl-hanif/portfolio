   ...
   <div style={{ background: "#000", color: "#fff", minHeight: "100vh" }}>
         ...
         >
           ...
           <h3 className="mb-4" data-aos="fade-up" data-aos-delay="200">
             Senior SQA Engineer | Manual & Automation Testing Expert
           </h3>
           <p
             className="lead mb-4"
             ...
             data-aos-delay="400"
           >
             Ensuring top-notch quality in web, mobile, and POS applications
             through robust testing strategies and modern QA tools.
           </p>
           <div data-aos="fade-up" data-aos-delay="600">
             <a href="#projects" className="btn btn-warning btn-lg me-3">
               View Projects
             </a>
